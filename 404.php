<?php
/**
 * ISS Investigations - 404 Error Page
...
<body class="bg-slate-50 text-slate-800 min-h-screen flex items-center justify-center">
    <div class="max-w-md mx-auto text-center">
        ...
        <div class="space-y-4">
            <a href="index.php" class="inline-block bg-primary hover:bg-primaryHover text-white font-bold py-3 px-6 rounded-lg shadow-lg shadow-primary/30 hover:shadow-lg hover:shadow-primary/40 transition-all transform hover:-translate-y-0.5">
                <i class="fas fa-home mr-2"></i>Return Home
            </a>
            <br>
            <a href="javascript:history.back()" class="text-slate-500 hover:text-primary transition-colors text-sm">
